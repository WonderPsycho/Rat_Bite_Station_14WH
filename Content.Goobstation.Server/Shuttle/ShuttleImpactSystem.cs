...
// using Content.Goobstation.Common.CCVar; //Ratbite Edit: Shuttle Collision disabled for now, in regards to many ghost role griefers shuttle crashing, will be brought back next time
